...
![|400](https://cdn.jsdelivr.net/gh/Gnblink0/Picture/img/20220419170157.png)

当动作电位到达轴突末端时，==化学信使（**神经递质**）被激活，从而跳进突触间隙，就像一个飞吻，然后再降落到有特定受体的神经细胞上==（一把钥匙开一把锁）。虽然神经递质会进入特定的受体，神经递质不会和接收信息的神经一直保持结合的状态，引起兴奋或抑制后，神经递质被泵出，然后被最开始释放出它们的神经细胞重新吸收。这个过程叫作**再摄取**（reuptake）。
...
- 激素种类
	...
	- **垂体（pituitary gland）**
		...
		![|500](https://cdn.jsdelivr.net/gh/Gnblink0/Picture/img/20220419185721.png)
...
在心理学界和人类实验领域中，一个推动着我们不断探索和前进的**问题**就是：==我们大脑的功能，是如何与心理活动相联系的？==（HOW DO OUR BRAINS' FUNCTIONS TIE TO THE
